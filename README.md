...
|------|--------|---------|-----------|
| 2415053122213 | Lê Hoàng Hải | Nhóm trưởng / Integration | Thiết kế DB, ERD, Tổng hợp tài liệu |
...
│   ├── UseCase_Admin_NV.png      # Sơ đồ use case Admin và Nhân viên
│   ├── UseCase_KhachHang.png     # Sơ đồ use case Khách hàng
│   └── SoDoNghiepVu.png          # Sơ đồ nghiệp vụ quy trình thuê xe
└── UI/
...
- 🎨 [Figma — Giao diện](https://www.figma.com/design/iJJsyOlmU2e2YX6h9Aqvva)
- 📋 [Trello — Phân task](https://trello.com/b/932nuUD1/quan-ly-thue-xe-o-to)
- 💻 [GitHub Repo](https://github.com/LeHai1004/QuanLyThueXe)
